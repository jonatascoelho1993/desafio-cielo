...
class ClienteComponentTest {
	...
	void cadastrarClientePessoaFisica() {
		...
		ClienteDTO cliente1 = ClienteDTO.builder().email("coelho@coelho.com.br").mcc(2345L)
				.nomeCliente("Jonatas Coelho").registroFederal("514.732.250-78").tipoPessoa("PF").build();

		ClienteDTO retorno = clienteComponent.cadastrarCliente(cliente1);
